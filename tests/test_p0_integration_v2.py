...
净利率: 25%"""
    ...
    def test_04_flow_verification(self):
        ...
        doc_path = self.create_test_doc('annual_report.txt', 
            """# 2024 年度报告
...
if __name__ == '__main__':
    ...
    # 输出总结
    print("\n" + "="*70)
    print(f"测试结果: {result.testsRun} 运行, {result.testsRun - len(result.failures) - len(result.errors)} 通过")
