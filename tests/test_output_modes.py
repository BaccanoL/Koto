...
async def test_flexible_output_modes():
    ...
    print(f"✅ 结果: {output_type1 == 'generate'} - {'✓ 通过' if output_type1 == 'generate' else '✗ 失败'}")
    ...
    print(f"✅ 结果: {output_type2 == 'generate'} - {'✓ 通过' if output_type2 == 'generate' else '✗ 失败'}")
    ...
    print(f"✅ 结果: {output_type3 == 'analysis'} - {'✓ 通过' if output_type3 == 'analysis' else '✗ 失败'}")
    ...
    print(f"✅ 结果: {output_type4 == 'generate'} - {'✓ 通过' if output_type4 == 'generate' else '✗ 失败'}")
