...
from app.core.remediation.remediation_manager import (
    RemediationManager, RemediationStatus, RemediationAction
)
...
class TestTrendAnalysis(unittest.TestCase):
    ...
    def test_predict_issues(self):
        ...
        events = [
            {"event_type": "cpu_high", "severity": "high"} for _ in range(10)
        ]
    ...
    def test_anomaly_score(self):
        ...
        normal_events = [
            {"event_type": "test", "severity": "low"} for _ in range(1)
        ]
        ...
        anomaly_events = [
            {"event_type": "test", "severity": "high"} for _ in range(30)
        ]
