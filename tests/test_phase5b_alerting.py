...
from app.core.monitoring.alert_manager import (
    AlertManager, AlertRule, AlertChannel, get_alert_manager
)
...
class TestAlertManager(unittest.TestCase):
    ...
    def test_add_webhook(self):
        ...
        result = self.manager.add_webhook(
            "slack",
        ...
        self.assertEqual(self.manager.webhook_urls["slack"], "https://hooks.slack.com/webhook")
