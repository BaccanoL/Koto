...
class TestSystemEventMonitor(unittest.TestCase):
    ...
    def test_filter_by_event_type(self):
        ...
        self.monitor._record_event(
            ...
            metric_name="cpu", metric_value=90, threshold=85,
            description="CPU high"
        )
        self.monitor._record_event(
            event_type="memory_high", severity="high",
            metric_name="memory", metric_value=95, threshold=90,
    ...
    def test_event_limit_100(self):
        ...
        for i in range(150):
            self.monitor._record_event(
                ...
                metric_name="test", metric_value=10, threshold=50,
                description=f"Event {i}"
            )
    ...
    def test_get_summary(self):
        ...
        self.monitor._record_event(
            event_type="critical", severity="high",
            metric_name="test", metric_value=100, threshold=80,
