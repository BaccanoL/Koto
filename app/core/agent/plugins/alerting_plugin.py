...
from app.core.monitoring.alert_manager import (
    get_alert_manager, AlertRule, AlertChannel
)
...
class AlertingPlugin(AgentPlugin):
        ...
        return [
            ...
            },
            {
                ...
                "parameters": {
                    ...
                    "required": ["rule_name", "event_types", "min_severity", "alert_channels"]
                }
            },
            {
    ...
    def create_alert_rule(
        ...
        try:
            ...
            if result:
                return f"Alert rule '{rule_name}' created successfully.\n" \
    ...
    def test_alert_rule(self, rule_name: str) -> str:
        ...
        if alert_id:
            return f"Test alert sent successfully for rule '{rule_name}' (ID: {alert_id})"
        else:
    ...
    def _create_alert_rule(self, params: Dict[str, Any]) -> str:
        ...
        try:
            ...
            if result:
                return f"Alert rule '{params['rule_name']}' created successfully.\n" \
