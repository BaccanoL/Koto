...
from app.core.remediation.remediation_manager import (
    get_remediation_manager, RemediationStatus
)
...
class AutoRemediationPlugin(AgentPlugin):
    ...
    def create_remediation_action(
        ...
        try:
            ...
            return f"Remediation action created (ID: {action_id})\n" \
                   f"Type: {action_type}\n" \
    ...
    def approve_remediation_action(
        ...
        try:
            ...
            if result:
                return f"Remediation action '{action_id}' approved\n" \
                       f"Ready for execution"
            else:
                return f"Failed to approve action '{action_id}' - may already be processed"
        except Exception as e:
    ...
    def reject_remediation_action(
        ...
        try:
            ...
            if result:
                ...
                return f"Failed to reject action '{action_id}' - may already be processed"
        except Exception as e:
    ...
    def execute_remediation_action(self, action_id: str) -> str:
        ...
        try:
            ...
            if result:
                return f"Remediation action '{action_id}' started execution\n" \
                       f"Status: Executing"
            else:
                return f"Failed to execute action '{action_id}' - must be approved first"
        except Exception as e:
